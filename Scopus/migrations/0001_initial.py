    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('abstract', models.TextField(default=b'', help_text=b'The article abstract', max_length=10000)),
            ],
            options={
                'db_table': 'abstract',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.CharField(help_text=b'The original (untranslated) title', max_length=500)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('scopus_source_id', models.BigIntegerField(default=-1, help_text=b"Scopus's srcid", db_index=True)),
